...
class fcomplex(_object):
    ...
    if _newclass:r = _swig_property(_presto.fcomplex_r_get, _presto.fcomplex_r_set)
    __swig_setmethods__["i"] = _presto.fcomplex_i_set
    __swig_getmethods__["i"] = _presto.fcomplex_i_get
    if _newclass:i = _swig_property(_presto.fcomplex_i_get, _presto.fcomplex_i_set)
    def __init__(self): 
...
def good_factor(*args):
  return _presto.good_factor(*args)
...
def gen_fvect(*args):
  return _presto.gen_fvect(*args)
gen_fvect = _presto.gen_fvect

def gen_cvect(*args):
  return _presto.gen_cvect(*args)
...
def switch_f_and_p(*args):
  return _presto.switch_f_and_p(*args)
