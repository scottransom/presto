...
#define  SWIGTYPE_p_orbitparams swig_types[0] 
#define  SWIGTYPE_p_binaryprops swig_types[1] 
#define  SWIGTYPE_p_double swig_types[2] 
#define  SWIGTYPE_p_makedata swig_types[3] 
#define  SWIGTYPE_p_dcomplex swig_types[4] 
#define  SWIGTYPE_p_fcomplex swig_types[5] 
#define  SWIGTYPE_p_rderivs swig_types[6] 
#define  SWIGTYPE_p_float swig_types[7] 
#define  SWIGTYPE_p_DoubleArray swig_types[8] 
#define  SWIGTYPE_p_rzwerrs swig_types[9] 
#define  SWIGTYPE_p_rawbincand swig_types[10] 
#define  SWIGTYPE_p_fourierprops swig_types[11] 
#define  SWIGTYPE_p_FILE swig_types[12] 
#define  SWIGTYPE_p_infodata swig_types[13] 
#define  SWIGTYPE_p_foldstats swig_types[14] 
