...
{
    fprintf(stderr, "%s",
            "   [-o outfile] [-nohdr] [-stdout] [-floats] [-zerolags] [-skip skip] [-numout numout] [-downsamp downsamp] [-lokill lokill] [-hikill hikill] [--] fitsfiles ...\n");
    fprintf(stderr, "%s",
            "      Converts raw GBT Spigot FITs files (lag data) into SIGPROC-style filterbank format.\n");
    fprintf(stderr, "%s",
            "           -o: Output file name (optional; for a single output file)\n");
