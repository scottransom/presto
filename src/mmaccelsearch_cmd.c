...
usage(void)
{
 ...
 [-lobin lobin] [-numharm numharm] [-zmax zmax] [-sigma sigma] [-rlo rlo] [-rhi rhi] [-flo flo] [-fhi fhi] [-photon] [-zapfile zapfile] [-baryv baryv] [--] infile\n\
    Uses memory-mapping to search an FFT or short time series for pulsars using a Fourier domain acceleration search with harmonic summing.\n\
    -lobin: The first Fourier frequency in the data file\n\
  ...
  -zapfile: A file of freqs and widths to zap from the FFT (when using '-zap')\n\
    ...
    -baryv: The radial velocity component (v/c) towards the target during the obs\n\
            ...
            default: `0.0'\n\
    infile: Input file name of the floating point .fft or .dat file.  A '.inf' file of the same name must also exist\n\
            1 value\n\
version: 18Jul04\n\
");
  exit(EXIT_FAILURE);
