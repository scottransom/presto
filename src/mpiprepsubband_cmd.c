...
void usage(void)
{
 ...
 -o outfile [-pkmb] [-gmrt] [-bcpm] [-spigot] [-filterbank] [-wapp] [-window] [-numwapps numwapps] [-if ifs] [-clip clip] [-noclip] [-numout numout] [-nobary] [-DE405] [-lodm lodm] [-dmstep dmstep] [-numdms numdms] [-nsub nsub] [-downsamp downsamp] [-mask maskfile] [--] infile ...\n\
